        ...
        prev.map((msg) =>
          msg.id === aiMsgId
            ? {
                ...
                isStreaming: false,
                content:
                  "Matrix Lite v2 bị nhiễu loạn băng thông, quá trình tính toán bị ngắt quãng. Vui lòng thử lại.\nLỗi hệ thống: " +
                  errorMsg,
              }
            : msg,
        ),
            ...
            <div className="w-full max-w-5xl mx-auto flex items-center justify-between">
              ...
              >
                ...
                <button
                  ...
                  className="p-1.5 md:p-2 rounded theme-panel-hover disabled:opacity-30 transition-colors cursor-pointer"
                >
                  <ChevronLeft size={16} />
                </button>
                <div
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2 md:p-2.5 rounded-lg theme-panel shadow-none border-transparent theme-panel-hover border border-transparent text-slate-600 dark-theme:text-white/70 hover:theme-text-base transition-colors cursor-pointer"
                  title="Lên đầu"
                >
                  <ArrowUp size={16} />
                </button>
